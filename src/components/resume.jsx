          ...
          >
            ...
            <pre>
              <p className="text-wrap">
                York • andras.gotts@outlook.com <br />
            ...
            <p>
              ...
              <br />
              and testing. Skilled in communication, teamwork, and
              problem-solving. Experience in delivering
              <br />
              projects from concept to implementation through university
              coursework and group
              <br />
              collaborations. Adaptable, innovative, and committed to continuous
            ...
            <pre>
              <p className="text-wrap">
                ...
                using GANs and diffusion models. Overcame hardware constraints
                by researching and implementing CycleGAN, adapting project scope
                to achieve viable results.
                <br /> ● Integrated pre-trained models from HuggingFace,
                demonstrating resourcefulness in leveraging state-of-the-art AI
                for constrained environments.
                <br /> ● Balanced multiple academic projects through effective
                time management and prioritization, consistently delivering to a
                high standard.
              </p>
            </pre>
            <br />
            ...
            <pre>
              <p className="text-wrap">
                ● As a group coordinated with a client through bi-weekly
                meetings, developing strong stakeholder communication skills and
                ensuring alignment on key project decisions. <br />●
                Collaborated using GitLab for version control and team-based
                development, contributing to different components of the
                project.
              </p>
            </pre>
            <pre>
              <p className="text-wrap">
                ● Designed and implemented interactive mini-games by learning
