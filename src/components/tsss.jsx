    ...
    <div>
      ...
      <div className="relative h-screen">
        <div className="absolute inset-0">
          <div className="relative h-full w-full bg-neutral-900 [&>div]:absolute [&>div]:inset-0 [&>div]:bg-fuchsia-400 [&>div]:bg-[size:20px_20px] [&>div]:opacity-20 [&>div]:blur-[100px]">
            <div></div>
          </div>
        </div>
      </div>
      <header className="bg-emerald-600 sticky top-0 z-[20] mx-auto flex w-full items-center justify-between border-b border-gray-500 p-8 rounded-2xl">
        <h1>Header</h1>
        <nav className="w-1/3">
          <div className="flex justify-between">Projects</div>
        </nav>
      </header>
      <body className="bg-[#313178]">
        <section className="bg-[#4e4e94] dark:bg-gray-900">
